        ...
        <div className=" py-10 w-11/12 mx-auto">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className=" bg-[#8fe6ac] !text-white hover:scale-105   hover:transition-all  duration-300 border-2  ease-linear overflow-hidden shadow-lg rounded-lg p-6 hover:shadow-xl "
                    >
