...
const Home = () => {
    ...
    return (
        <div className={`${theme ? "bg-white  overflow-x-hidden" : "bg-black text-white  overflow-x-hidden"} ` }>

            <Helmet><title>SE | Home</title></Helmet>

            <div className="  flex justify-end mx-5 "><label className="swap swap-rotate fixed top-16 text-[#4eef83] z-50">
